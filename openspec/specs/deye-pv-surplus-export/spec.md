...
Enable Deye inverters to export excess PV power to the grid while simultaneously charging the battery. This capability allows Darkstar to optimize energy arbitrage during high PV production periods and price spikes, matching the functionality available on Fronius and Sungrow inverters.
