...
Provide a D+1 price forecast accuracy API endpoint and display the MAE metric in the Aurora KPI strip, replacing the Max Price Spread card when price forecasting is enabled.
