...
The Settings UI SHALL provide configuration for excess PV utilization, including sink selection (water heater boost, custom entity, or disabled), boost reward, and related parameters.
